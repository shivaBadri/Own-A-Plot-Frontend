// Design tokens governed by ui.md (rules 1, 3, 4, 9). All font sizes must be
// fluid clamp() values; do not add fixed-px font sizes. Interaction transitions
// stay within the 300–800ms band.
